...
export function MissionPanel({ view, section = 'all' }: { view: View; section?: 'all' | 'insights' | 'events' }) {
  return <div className="mission-panel">
    {section !== 'events' && <section aria-label="Scenario objectives"><h2>Mission objectives</h2><p className="objective-note">Live progress is provisional until the result.</p>
    ...
    {section !== 'insights' && <section aria-label="Simulation event feed"><h2>Operations log</h2>
