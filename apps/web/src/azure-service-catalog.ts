...
export const azureServices: Record<AzureServiceId, AzureServiceDefinition> = {
  ...
  'sql-database': { id: 'sql-database', name: 'Azure SQL Database', category: 'data', role: 'Data tier · handles reads and order writes.', icon: serviceIcons.database!.src, fallback: 'SQL', playable: true, scope: 'Fixed capacity in this game; not directly scalable.' },
