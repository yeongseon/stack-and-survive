...
export const azureTutorialSteps = [
  ...
  { title: 'Choose one change to try', text: 'Scale out App, cache eligible reads with Managed Redis, or filter bots with Protected Edge. Changes take time and add running costs; writes still need SQL.', highlight: 'actions' },
] as const;
