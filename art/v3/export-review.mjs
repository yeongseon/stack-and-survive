...
import { facilityNames, facilitySvg } from './core-facilities.mjs';
...
try {
  ...
  await writeFile(`${output}/review-inventory.json`, JSON.stringify({ status: 'source-study-not-runtime-approved', records }, null, 2) + '\n');
