...
Business feedback uses actual served orders/tick revenue, never spendable budget or duplicate per-render rewards. Optional audio, haptics and contextual first-run tutorial are planned, not implemented.
