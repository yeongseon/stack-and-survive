...
Current official Azure SVG files are identity assets. The existing custom buildings and scenery are generated by Phaser Graphics; they are not a production PNG/WebP sprite set. Neither the existence of distinct silhouettes nor the phrase “imports require provenance” establishes that an art-file pipeline has been delivered.
