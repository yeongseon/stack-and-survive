# Historical technical proposal — not current authority

See [current technical design](../TECHNICAL_DESIGN.md). Proposed hosting and packages below are not evidence of deployment.
