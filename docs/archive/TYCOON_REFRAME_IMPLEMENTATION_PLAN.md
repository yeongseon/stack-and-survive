# Historical Phase 1 reframe — not current authority

See [current gameplay](../GAMEPLAY_SPEC.md) and [current plan](../IMPLEMENTATION_PLAN.md). Obsolete restrictions below are historical only.
