...
export type Resource = { id: string; kind: Kind; x: number; y: number; instances: number; remaining: number; tier?: ResourceTier; readReplicas?: number };
...
export type Scenario = Readonly<{
  schemaVersion: 1; balanceVersion: '0.2' | '0.3' | '0.4'; id: string; duration: number; budget: number;
